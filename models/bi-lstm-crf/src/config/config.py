...
class Config:
    def __init__(self, args) -> None:
        ...
        self.train_file = "../benchmark_dataset/train.txt"
        self.dev_file = "../benchmark_dataset/dev.txt"
        self.test_file = "../benchmark_dataset/test.txt"
    ...
    def read_pretrain_embedding(self) -> Tuple[Union[Dict[str, np.array], None], int]:
        ...
        if self.embedding_file is None:
            ...
            exists = os.path.isfile('glove.6B.100d.txt')
            if not exists:
